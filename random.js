...
function getRandomUserName(min, max) {
  let temStringArr = '123456789qwertyuiopasdfghjklzxcvbnm'.split('')
  let outPutText = ''
  for (let i = 0; i < getRandomNum(min,max); i++) {
    outPutText += temStringArr[getRandomNum(0,temStringArr.length)]
  }
  return outPutText
}
...
for (let i = 0; i < 2000000; i++) {
  tempInfo.push({
    ...
    randNum10: getRandomNum(100000,999999)
  })
}
